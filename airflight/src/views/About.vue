            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                    <div class="about-details-cap p-2 pt-3 pl-2 pr-2 pb-0 ">
                        ...
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed mollis venenatis quam, vitae commodo arcu gravida ut. Nulla risus lectus, sollicitudin quis ligula in, sagittis fringilla mauris. Proin hendrerit pharetra turpis, a posuere tortor aliquet in. Praesent purus quam, imperdiet ut elit quis, lacinia pulvinar sapien. Curabitur sollicitudin nibh dolor, quis semper ligula consectetur sed.
                        </p>
                    </div>
                    ...
                    <div class="about-details-cap p-2 pt-3 pl-2 pr-2 pb-3">
                        <h4>Our Vision</h4>
                        <p>
                           Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec a iaculis massa, eget laoreet sem. Fusce at consectetur velit. 
                        </p>
                        <p>  
                            Praesent pulvinar pulvinar fringilla. Fusce porttitor odio in sapien elementum, at semper lectus mollis. Etiam et mauris eget lorem varius congue. Curabitur sagittis augue hendrerit pretium pellentesque. Cras ac tincidunt urna. Aenean maximus in erat eu interdum.
                        </p>
                    </div>
                </div>
                ...
                <div class="row d-flex justify-content-between">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="single-method mb-40">
                          <img class="icon" src="../assets/cart.jpg" alt=""/>
                          <h6>Free Shipping Method</h6>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="single-method mb-40">
                           <img class="icon" src="../assets/secure.png" alt=""/>
