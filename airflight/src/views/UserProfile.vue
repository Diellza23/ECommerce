            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex flex-column align-items-center text-center">
                  ...
                  />
                  <div class="mt-3">
                    <h4 class="text-secondary mb-1">Vue Shop User</h4>
            ...
            <div class="card mt-3">
              <ul class="list-group list-group-flush">
                ...
                >
                  ...
                  <span class="text-secondary">https://ourApp.com</span>
                </li>
                <li
                  class="list-group-item d-flex justify-content-between align-items-center flex-wrap"
                >
                ...
                >
                  ...
                  <span class="text-secondary">twitter.com</span>
                </li>
                <li
                  class="list-group-item d-flex justify-content-between align-items-center flex-wrap"
                >
                  ...
                  <div class="card-body">
                    <h6 class="d-flex align-items-center mb-3">
                      <i class="material-icons text-info mr-2"
                        >Assignment Project Status</i
                      >
                    </h6>
                    <small>Web Design-VueJS</small>
                    ...
                    <small>Mobile Template-Responsive</small>
                    <div class="progress mb-3" style="height: 5px">
                      <div
                        class="progress-bar bg-primary"
                        role="progressbar"
                    ...
                    <small>Backend API- NodeJS</small>
                    <div class="progress mb-3" style="height: 5px">
                      <div
                        class="progress-bar bg-primary"
                        role="progressbar"
              ...
              <div class="col-sm-6 mb-3">
                <div class="card h-100">
                  <div class="card-body">
                    ...
                    <div class="col-md-5 mt-2" style="margin-bottom: 20px">
                    ...
                    <small>Delete Account Here</small>
